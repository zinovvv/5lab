...
int main() {
    ...
    //Демонстрация работы с одномерным и двумерным массивом
    const int numAlbums = 3;
    Album arrAlbums[numAlbums] = {
        Album("Album 1", "Artist 1", 2023, 10,{}),
        Album("Album 2", "Artist 2", 2022, 12,{}),
        Album("Album 3", "Artist 3", 2021, 8,{})
    };

    // Вывод информации об альбомах из одномерного массива
    std::cout << "Вывод информации об альбомах из одномерного массива:" << std::endl;
    ...
    const int numRows = 2;
    const int numCols = 2;
    Album albumGrid[numRows][numCols] = {
        {
            Album("Album A1", "Artist A1", 2019, 7,{}),
            Album("Album A2", "Artist A2", 2020, 9,{})
        },
        {
            Album("Album B1", "Artist B1", 2018, 6,{}),
            Album("Album B2", "Artist B2", 2017, 11,{})
        }
    };

    // Вывод информации об альбомах из двумерного массива
    std::cout << "\nВывод информации об альбомах из двумерного массива:" << std::endl;
